document.addEventListener("DOMContentLoaded", function() {
  ...
  const raccoonData = [
    { src: "images/racoons1.jpeg",  message: "You are the Ancient King Raccoon!" },
    ...
    { src: "images/racoons6.png",   message: "You are the Soldier Raccoon!" },
    { src: "images/racoons7.png",   message: "You are the Green Goblin Raccoon!" },
    ...
    { src: "images/racoons14.jpeg", message: "You are the Guerrilla Raccoon!" },
